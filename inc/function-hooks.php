...
function enqueue_scripts__() {
  ...
  if(@get_field( 'animsition' )) :

    wp_enqueue_style( 'animsition-css', 'https://cdnjs.cloudflare.com/ajax/libs/animsition/3.2.1/css/animsition.min.css' );
    wp_enqueue_script( 'animsition-js', 'https://cdnjs.cloudflare.com/ajax/libs/animsition/3.2.1/js/animsition.min.js' );
  ...
  if(@get_field( 'images_loaded' )) :

    wp_enqueue_script( 'images-loaded-js', 'https://cdnjs.cloudflare.com/ajax/libs/jquery.imagesloaded/5.0.0/imagesloaded.min.js' );

  endif; 

  if(@get_field( 'fullpage_js' )) :

    wp_enqueue_style( 'fullpage-css', 'https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.7/jquery.fullpage.min.css' );
    wp_enqueue_script( 'fullpage-js', 'https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.7/jquery.fullpage.min.js' );
    wp_enqueue_script( 'fullpage-extensions-js', 'https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.7/jquery.fullpage.extensions.min.js' );
    wp_enqueue_script( 'fullpage-scroll-overflow-js', 'https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.7/vendors/scrolloverflow.min.js' );
    wp_enqueue_script( 'fullpage-easings-js', 'https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.7/vendors/jquery.easings.min.js.js' );
  ...
  if(@get_field( 'gsap' )) :
    ...
    wp_enqueue_script( 'gsap-easepack-js', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.0/EasePack.min.js' );
    wp_enqueue_script( 'gsap-scrolltrigger-js', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.0/ScrollTrigger.min.js' );

  endif;

  if(@get_field( 'scroll_magic' )) :

    wp_enqueue_script( 'scroll-magic-js', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.8/ScrollMagic.min.js' );
    wp_enqueue_script( 'scroll-magic-timelinelite-js', 'http://cdnjs.cloudflare.com/ajax/libs/gsap/latest/TimelineLite.min.js' );
    wp_enqueue_script( 'scroll-magic-tweenmax-js',  get_template_directory_uri(). '/js/ext/tweenmax.js' );
    wp_enqueue_script( 'scroll-magic-gsap-animation-js', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.8/plugins/animation.gsap.min.js' );
    wp_enqueue_script( 'scroll-magic-indicators-js', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.8/plugins/debug.addIndicators.min.js' );
  ...
  if(@get_field( 'slick' )) :
    ...
    wp_enqueue_style( 'slick-theme', get_template_directory_uri() . '/css/ext/slick-theme.css' );
    wp_enqueue_script( 'slick-js', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js' );

  endif;  

  if(@get_field( 'bootstrap_js' )) :

    wp_enqueue_script( 'bootstrap-js', 'https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.2.0/js/bootstrap.min.js' );

  endif; 
  
  if(@get_field( 'flickity' )) :

    wp_enqueue_style( 'flickity-css', 'https://cdnjs.cloudflare.com/ajax/libs/animsition/3.2.1/css/animsition.min.css' );
    wp_enqueue_script( 'flickity-js', 'https://cdnjs.cloudflare.com/ajax/libs/flickity/3.0.0/flickity.pkgd.min.js' );

  endif; 

  if(@get_field( 'infinite_scroll' )) :

    wp_enqueue_script( 'infinite-scroll-js', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-infinitescroll/4.0.1/infinite-scroll.pkgd.min.js' );

  endif; 

  if(@get_field( 'isotope' )) :

    wp_enqueue_script( 'isotope-js', 'https://unpkg.com/isotope-layout@3/dist/isotope.pkgd.min.js' );

  endif; 

  if(@get_field( 'masonry' )) :
  ...
  if(@get_field( 'magnific_popup' )) :

    wp_enqueue_style( 'magnefic-css', 'https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/magnific-popup.css' );
    wp_enqueue_script( 'magnefic-js',  'https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/jquery.magnific-popup.min.js' );
...
function emw_register_theme_settings(){
  ...
  :root {
    ...
    --primary-background-color__btn-default: <?php echo $theme_primary_btn['default']['color']; ?>;
    --primary-background-color__btn-hover: <?php echo $theme_primary_btn['hover_active']['color']; ?>;
    ...
    --secondary-background-color__btn-hover: <?php echo $theme_secondary_btn['hover_active']['color']; ?>;
